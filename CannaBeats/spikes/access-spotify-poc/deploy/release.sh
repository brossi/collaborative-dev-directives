...
state_schema_min="${CANNABEATS_STATE_SCHEMA_MIN_GENERATION:-2}"
state_schema_max="${CANNABEATS_STATE_SCHEMA_MAX_GENERATION:-2}"
state_protocol_min="${CANNABEATS_STATE_PROTOCOL_MIN_VERSION:-3}"
state_protocol_max="${CANNABEATS_STATE_PROTOCOL_MAX_VERSION:-3}"
